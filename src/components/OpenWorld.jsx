...
import heroImg from '../assets/Open_World_Hero.jpg'
import { CiSearch } from "react-icons/ci";
import { IoGridSharp } from "react-icons/io5"

import imgOne from '../assets/Open_World_Card_main_img1.jpg'
import imgTwo from '../assets/Open_World_Card_main_img2.jpg'
import imgThree from '../assets/Open_World_Card_main_img3.jpg'
import imgFour from '../assets/Open_World_Card_main_img4.jpg'
import imgFive from '../assets/Open_World_Card_main_img5.jpg'
import imgSix from '../assets/Open_World_Card_main_img6.jpg'
import imgSeven from '../assets/Open_World_Card_main_img7.jpg'
import imgEight from '../assets/Open_World_Card_main_img8.jpg'
import imgNine from '../assets/Open_World_Card_main_img9.jpg'
import imgTen from '../assets/Open_World_Card_main_img10.jpg'
import imgEleven from '../assets/Open_World_Card_main_img11.jpg'
import imgTwelve from '../assets/Open_World_Card_main_img12.jpg'
...
const OpenWorld = () => {
    ...
    return (
        <div className='main-bg min-h-[85vh] overflow-y-scroll flex justify-center relative z-0'>
            <img src={heroImg} alt="" className='absolute z-1' />
            <div className='flex bg-gradient-to-r from-black/80 via-neutral-200/10 to-black/80 h-[85vh] w-full flex-col items-center justify-Start absolute z-10' >
                ...
                <div className='font h-[20vh] text-5xl font-extrabold w-[70vw] flex justify-center items-center text-white my-2'> OPEN WORLD</div>
                <div className=' flex flex-col items-center w-[90vw]'>
                    <div className='flex py-2'>
                        ...
                        <div className='flex openworld-carouisel-box carousel-bg relative'>
                            <img src={mainImg} className='h-100' />
                            <div className='openworld-carousel-right-side min-w-[30vw] relative'>
                                <div className='openworld-carousel-right-side-title slider-title text-3xl px-2 py-2 text-white'>Read Dead Redemption 2</div>
                                ...
                                <p className='openworld-carousel-right-side-price absolute text-gray-200 text-xl px-2 py-2 bottom-0'>₹1799</p>
