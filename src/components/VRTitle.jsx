...
import heroImg from '../assets/VRTitle_Hero.jpg'
import { CiSearch } from "react-icons/ci";
import { IoGridSharp } from "react-icons/io5"

import imgOne from '../assets/VRTitle_Slider_img1.jpg'
import imgTwo from '../assets/VRTitle_Slider_img2.jpg'
import imgThree from '../assets/VRTitle_Slider_img3.jpg'
import imgFour from '../assets/VRTitle_Slider_img4.jpg'
import imgFive from '../assets/VRTitle_Slider_img5.jpg'
import imgSix from '../assets/VRTitle_Slider_img6.jpg'
import imgSeven from '../assets/VRTitle_Slider_img7.jpg'
import imgEight from '../assets/VRTitle_Slider_img8.jpg'
import imgNine from '../assets/VRTitle_Slider_img9.jpg'
import imgTen from '../assets/VRTitle_Slider_img10.jpg'
import imgEleven from '../assets/VRTitle_Slider_img11.jpg'
import imgTwelve from '../assets/VRTitle_Slider_img12.jpg'

import imgMain from '../assets/VRTitle_Carousel_Main.jpg'
...
const VRTitle = () => {
    ...
    return (
        <div className='main-bg min-h-[85vh] overflow-y-scroll flex justify-center relative z-0'>
            <img src={heroImg} alt="" className='absolute z-1 h-141 w-[100vw]' />
            <div className='flex bg-gradient-to-r from-black/80 via-neutral-200/10 to-black/80 h-[85vh] w-full flex-col items-center justify-Start absolute z-10' >
                ...
                <div className='font h-[20vh] text-5xl font-extrabold w-[70vw] flex justify-center items-center text-white my-2'>VR - TITLE</div>
                    ...
                    <div className='flex py-2'>
                        ...
                        <div className='flex openworld-carouisel-box carousel-bg relative'>
                            ...
                            <div className='openworld-carousel-right-side min-w-[30vw] relative'>
                                <div className='openworld-carousel-right-side-title slider-title text-3xl px-2 py-2 text-white'>VR Chat</div>
                                ...
                                <p className='openworld-carousel-right-side-price absolute text-gray-200 text-xl px-2 py-2 bottom-0'>Free To Play</p>
